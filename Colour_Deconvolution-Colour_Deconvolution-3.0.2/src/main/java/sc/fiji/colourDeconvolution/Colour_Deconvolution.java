...
// Read the paper!
//  
  public ImagePlus computeFirstStain(ImagePlus imp,String arg){
	    ...
	    if (gd.wasCanceled())
	      return;*/
	    String myStain = arg;
	    //System.out.println("my stain: " + myStain);
	    ...
	    ImageStack[] convImages = mt.compute(doIshow, hideLegend, imp);
	    return new ImagePlus("Deconvoluded",convImages[0]);
  }
  public void run(String arg) {
    ...
    System.out.println("my stain: " + myStain);
    boolean doIshow = false;
    System.out.println(doIshow);
    boolean hideLegend = false;
    System.out.println(hideLegend);
    StainMatrix mt = null; 
    ...
    mt.compute(doIshow, hideLegend, imp);
  }
